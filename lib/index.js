...
function innerRpc(request, callback) {
  ...
  var errorMessage = 'Trivechain JSON-RPC: '
    ...
    res.on('end', function () {
      ...
      if (
        ...
        var exceededError = new Error(
          'Trivechain JSON-RPC: ' + buf.toString('utf8')
        )
...
// For definitions of RPC calls, see various files in: https://github.com/trivechain/trivechain-core/tree/master/src
RpcClient.callspec = {
